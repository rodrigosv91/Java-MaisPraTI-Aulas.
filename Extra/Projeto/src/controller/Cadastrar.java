...
public class Cadastrar {
    ...
    public void cadastrarPessoa(String nome, String telefone, LocalDateTime dataNascimento){
    ...
    public void cadastrarAluno(String nome, String telefone, LocalDateTime dataNascimento, double notaFinal){
